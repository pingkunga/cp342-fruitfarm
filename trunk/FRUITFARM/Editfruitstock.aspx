<%@ Page Language="VB" CodeFile="Editfruitstock.aspx.vb" Inherits="Editfruitstock" %>
...
<body>
    ...
    <table cellpadding="4%" style="position:relative; font-weight:bold;width: 100%">
            ...
            <tr align="left">
                ...
                <td>
                    &nbsp;
                    <asp:TextBox ID="txtfprice" runat="server" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr align="left">
                <td></td>
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="False" NavigateUrl="Fruitstock.aspx">View Member</asp:HyperLink>
    </div>
