<%@ Page Language="VB" CodeFile="Order.aspx.vb" Inherits="Order" %>
...
<form id="form1" runat="server">
    ...
    <h1>Order List&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;search&nbsp;
        <asp:DropDownList ID="OrderTableList" runat="server">
            ...
            <asp:ListItem Value="OH.C_ID">Customer ID</asp:ListItem>
            <asp:ListItem Value="C.C_FNAME">Customer Name</asp:ListItem>
            <asp:ListItem Value="OD.order_price">Price</asp:ListItem>
...
&nbsp;&nbsp;
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="true" NavigateUrl="Insertorder.aspx">Add Order</asp:HyperLink>
