...
Partial Class Orderuserdetail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Session("orderuser") = Request.QueryString("order_number")
    ...
    Sub BindData()
        ...
        strSQL = "SELECT OD.order_number,OD.f_id,FS.f_name,OD.order_quantity_kg,OD.order_price FROM ORDERDETAIL OD JOIN ORDERHEAD OH ON(OD.order_number=OH.order_number) " & _
                    " JOIN FRUITSTOCK FS ON(FS.f_id=OD.f_id) WHERE OD.order_number = '" & Request.QueryString("order_number") & "' "

        Try
            total = "SELECT SUM(order_price) FROM ORDERDETAIL WHERE order_number = '" & Request.QueryString("order_number") & "' "
    ...
    Sub myRepeater_ItemCommand(ByVal source As Object, ByVal e As RepeaterCommandEventArgs) Handles myRepeater.ItemCommand
        If e.CommandName = "Delete" Then
            ...
            checkD = "SELECT status FROM ORDERHEAD OH JOIN ORDERDETAIL OD ON(OH.order_number=OD.order_number) where OD.order_number = '" & lblorder_number.Text & "' "
