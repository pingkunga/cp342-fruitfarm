<%@ Page Language="VB" CodeFile="Editorchard.aspx.vb" Inherits="Editorchard" %>
...
<body>
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="False" NavigateUrl="Orchard.aspx">View Orchard</asp:HyperLink>
    </div>
