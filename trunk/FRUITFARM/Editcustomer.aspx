<%@ Page Language="VB" CodeFile="Editcustomer.aspx.vb" Inherits="Editcustomer" %>
...
<body>
    ...
    <table cellpadding="4%" style="position:relative; font-weight:bold;width: 100%">
            <tr align="left">
                ...
                <td>
                    &nbsp;
                    <asp:TextBox ID="txtc_id" runat="server" Width="300px" ReadOnly></asp:TextBox>
                </td>
            </tr>
            <tr align="left">
                <td>
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="False" NavigateUrl="Customer.aspx">View Customer</asp:HyperLink>
    </div>
