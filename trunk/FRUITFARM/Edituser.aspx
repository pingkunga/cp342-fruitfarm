<%@ Page Language="VB" CodeFile="Edituser.aspx.vb" Inherits="Edituser" %>
...
<form id="form1" runat="server">
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="False" NavigateUrl="User.aspx">View Personal Detail</asp:HyperLink>
    </div>
