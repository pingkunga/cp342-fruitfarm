...
<body>
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="False" NavigateUrl="Insertcustomer.aspx">Back to Add Customer Page</asp:HyperLink><br />
    <asp:HyperLink ID="HyperLink2" runat="server" Visible="False" NavigateUrl="Customer.aspx">View Customer</asp:HyperLink>
    </div>
