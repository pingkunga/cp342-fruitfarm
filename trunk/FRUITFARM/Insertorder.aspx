<%@ Page Language="VB" CodeFile="Insertorder.aspx.vb" Inherits="Insertorder" %>
...
<body>
    ...
    <table cellpadding="4%" style="position:relative; font-weight:bold;width: 95%">
            ...
            <tr align="left">
                ...
                <td>
                    &nbsp;
                    <asp:DropDownList ID="CustList1" runat="server" DataSourceID="SqlDataSource1" 
                        DataTextField="C_ID" DataValueField="C_ID">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
                        SelectCommand="SELECT &quot;C_ID&quot; FROM &quot;CUSTOMER&quot; ORDER BY &quot;C_ID&quot;">
                    </asp:SqlDataSource>
                </td>
            </tr>
            <tr align="left">
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="False" NavigateUrl="Insertorder.aspx">Back to Add Order List Page</asp:HyperLink><br />
    <asp:HyperLink ID="HyperLink2" runat="server" Visible="False" NavigateUrl="Order.aspx">View Order List</asp:HyperLink>
    </div>
