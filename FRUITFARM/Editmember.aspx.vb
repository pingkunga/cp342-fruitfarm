...
Partial Class Editmember
    ...
    Sub ViewData()
        ...
        strSQL = "SELECT * FROM MEMBER WHERE m_id = '" & Request.QueryString("m_id") & "' "
        dtAdapter = New OleDbDataAdapter(strSQL, objConn)
        dtAdapter.Fill(dt)

        If dt.Rows.Count > 0 Then
            Me.txtm_id.Text = dt.Rows(0)("m_id")
            Me.txtm_fname.Text = dt.Rows(0)("m_fname")
            Me.txtm_lname.Text = dt.Rows(0)("m_lname")
            Me.PositionList1.SelectedValue = dt.Rows(0)("p_id")
    ...
    Sub btnEdit_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnEdit.Click
        ...
        " m_id = '" & Me.txtm_id.Text & "' " & _
        " ,m_fname = '" & Me.txtm_fname.Text & "' " & _
        " ,m_lname = '" & Me.txtm_lname.Text & "' " & _
        " ,p_id = '" & Me.PositionList1.SelectedValue & "' " & _
        ...
        " WHERE m_id = '" & Request.QueryString("m_id") & "' "
