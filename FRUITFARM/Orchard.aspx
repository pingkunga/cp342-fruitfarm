<%@ Page Language="VB" CodeFile="Orchard.aspx.vb" Inherits="Orchard" %>
...
<form id="form1" runat="server">
    ...
    <h1>Orchard&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        search&nbsp;
        <asp:DropDownList ID="OrcTableList" runat="server">
            <asp:ListItem Value="ORC_ID">Orchard ID</asp:ListItem>
            <asp:ListItem Value="ORC_NAME">Orchard</asp:ListItem>
...
&nbsp;&nbsp;
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="true" NavigateUrl="Insertorchard.aspx">Add Orchard</asp:HyperLink>
	...
	<ItemTemplate>
		<tr>
			<td align="center"><asp:Label id="lblorc_id" runat="server"></asp:Label></td>
			<td><asp:Label id="lblorc_name" runat="server"></asp:Label></td>
			<td><asp:Label id="lblorc_address" runat="server"></asp:Label></td>
			<td align="right"><asp:Label id="lblprovince_id" runat="server"></asp:Label></td>
            <td align="right"><asp:Label id="lblorc_tel" runat="server"></asp:Label></td>
            <td align="right"><asp:Label id="lblorc_email" runat="server"></asp:Label></td>
