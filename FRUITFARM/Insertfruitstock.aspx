<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Insertfruitstock.aspx.vb" Inherits="Insertfruitstock" %>
...
<body>
    ...
    <table cellpadding="4%" style="position:relative; font-weight:bold;width: 95%">
            <tr align="left">
                ...
                <td>
                    &nbsp;
                    <asp:TextBox ID="txtf_id" runat="server" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr align="left">
                <td>
                ...
                <td>
                    &nbsp;
                    <asp:TextBox ID="txtf_name" runat="server" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr align="left">
                <td>
                ...
                <td>
                    &nbsp;
                    <asp:TextBox ID="txtinstock_kg" runat="server" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr align="left">
                <td>
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="False" NavigateUrl="Insertfruitstock.aspx">Back to Add Fruit Page</asp:HyperLink><br />
    <asp:HyperLink ID="HyperLink2" runat="server" Visible="False" NavigateUrl="Fruitstock.aspx">View Fruit Stock</asp:HyperLink>
    </div>
