<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Insertbilldetail.aspx.vb" Inherits="InsertBIS" %>
...
<body>
    ...
    <table cellpadding="4%" style="position:relative; font-weight:bold;width: 95%">
            ...
            <tr align="left">
                ...
                <td>
                    &nbsp;
                    <asp:TextBox ID="txtbill_quantity_kg" runat="server" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr align="left">
                <td>
                ...
                <td>
                    &nbsp;
                    <asp:TextBox ID="txtbill_price" runat="server" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr align="left">
                <td class="style2"></td>
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="False" NavigateUrl="Insertbilldetail.aspx">Back to Add Bill Detail List Page</asp:HyperLink><br />
    <asp:LinkButton ID="HyperLink3" runat="server" Visible="False">View Bill List</asp:LinkButton>
    </div>
