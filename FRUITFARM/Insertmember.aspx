<%@ Page Language="VB" CodeFile="Insertmember.aspx.vb" Inherits="Insertmember" %>
...
<body>
    ...
    <table cellpadding="4%" style="position:relative; font-weight:bold;width: 95%">
            ...
            <tr align="left">
                ...
                <td>
                    &nbsp;
                    <asp:TextBox ID="txtm_password" runat="server" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr align="left">
                <td>
            ...
            <tr align="left">
                ...
                <td>
                    &nbsp;
                    <asp:DropDownList ID="ProvinceList1" runat="server" DataSourceID="SqlDataSource2" 
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="False" NavigateUrl="Insertmember.aspx">Back to Add Member Page</asp:HyperLink><br />
    <asp:HyperLink ID="HyperLink2" runat="server" Visible="False" NavigateUrl="Member.aspx">View Member</asp:HyperLink>
    </div>
