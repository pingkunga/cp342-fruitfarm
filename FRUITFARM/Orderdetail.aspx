<%@ Page Language="VB" CodeFile="Orderdetail.aspx.vb" Inherits="Orderdetail" %>
...
<form id="form1" runat="server">
    ...
    <h1>Order Detail</h1> 
    <asp:HyperLink ID="HyperLink2" runat="server" Visible="true" NavigateUrl="Insertorderdetail.aspx">Add Order Detail</asp:HyperLink>    
    &nbsp;
    <asp:HyperLink ID="HyperLink1" runat="server" Visible="true" NavigateUrl="Order.aspx">Back</asp:HyperLink>
