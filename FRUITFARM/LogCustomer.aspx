<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LogCustomer.aspx.vb" Inherits="LogCustomer" %>
...
<body>
   <form id="form1" runat="server">
    ...
    CUSTOMER
    <asp:Panel ID="Panel1" runat="server" Height="150px" Visible="True" Width="814px">
            <table cellpadding="4%" border="0" style="position:relative;font-weight:bold">               
                <tr>
                    <td>Your Name :</td>
                    <td><asp:TextBox ID="CustUser" runat="server" Width="150px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Password :</td>
                    <td><asp:TextBox ID="CustPass" runat="server" TextMode="Password" Width="150px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td></td>
                    <td><asp:Button ID="LinkButton1" runat="server" Text="Login" /></td>
                </tr>
            </table>                    
    </asp:Panel>
